                ...
                <form id="edit" action="./index.php" method="post" enctype="multipart/form-data">
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            <div class=" col-md-3">
                                <?php
                                    $filePath = './public/foto_mhs/';

                                    if (is_readable($filePath) && file_exists($filePath . "foto_" . $mhs['nama'] . ".png") == true) {
                                        ...
                                        echo '<script>console.log("DATA TIDAK ADA !");
                                </script>';
                                    }
                                    ?>
                                '<script>
                                console.log("<?= $filePath . "foto_" . $mhs['nama'] ?>".
                                    ".png");
                                </script>'
